...
[`@aws-sdk/client-iot`](https://www.npmjs.com/package/@aws-sdk/client-iot/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cD4TCF/bi/PTErRMIMjefluL90sPWF8vWGBCdc6MjgKeI5CKVpfD4cktET+ReQjq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iot": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot@3.777.0/index.min.mjs": "sha384-cD4TCF/bi/PTErRMIMjefluL90sPWF8vWGBCdc6MjgKeI5CKVpfD4cktET+ReQjq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iot/blob/refs/tags/3.777.0/LICENSE
```
