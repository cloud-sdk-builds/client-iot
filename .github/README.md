...
[`@aws-sdk/client-iot`](https://www.npmjs.com/package/@aws-sdk/client-iot/v/3.14.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot@3.14.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4aybjx/quqFT4C9bWO+vmv6XBZearkQxTjkInfzWEEsmV1khG+NO1LsceMi7f2rU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iot": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot@3.14.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot@3.14.0/index.min.mjs": "sha384-4aybjx/quqFT4C9bWO+vmv6XBZearkQxTjkInfzWEEsmV1khG+NO1LsceMi7f2rU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iot/blob/refs/tags/3.14.0/LICENSE
```
